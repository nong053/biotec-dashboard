...
<!--------------------- Function --------------------->
	...
	<table id="Detail-Panel" width="100%"><tr>
		<td><iframe name="Details_TB" id="Details_TB" width=100% height="400" src="./bg.html" marginwidth="0" marginheight="0" vspace="0" hspace="0" frameborder="0" align="middle" scrolling="no"></iframe></td>
		<td width="350px"><iframe name="Details_Chart" id="Details_Chart" width=100% height="400" src="./bg.html" marginwidth="0" marginheight="0" vspace="0" hspace="0" frameborder="0" align="middle" scrolling="no"></iframe></td>
	</tr></table>
	<!--------------------------- End Details --------------------------->
	</body>
</html>