...
titleStr="ผลสำเร็จ สายงานด้านกลยุทธ์และสนับสนุนได้ " + ParamScore +" คะแนน" + orgFile;
...
<div id="contentMain1">
	<div id="contentL">
	<img src="owner_picture/ns.jpg">
	</div>
	<div id="contentR">
		<div id="contentDetail">
		ตัวชี้วัดผลสำเร็จสายงานด้านกลยุทธ์และสนับสนุน<br>ประจำปีงบประมาณ <%=YearBY%>
		</div>
	</div>
</div>
<br style="clear:both">
