...
String dataLevel5="";
	Query="CALL sp_profit_and_loss_list_by_center_per_level("+paramYear+","+paramMonth+",'"+paramArea+"',8,"+paramParentKey+");";
	...
	while(rs.next()){
		...
		*/
		...
		dataLevel5+="\"Field2\":\"<div class='textR'>"+rs.getString("pMonthAmt")+"</div>\",";
		dataLevel5+="\"Field3\":\"<div class='textR'>"+rs.getString("currentAmt")+"</div>\",";
		dataLevel5+="\"Field5\":\"<div class='textR'>0%</div>\",";
		dataLevel5+="\"Field6\":\"<div class='textR'>"+rs.getString("pYearAmt")+"</div>\"";
		dataLevel5+="}" ;
		}else{
		dataLevel5+=",{" ;
		dataLevel5+="\"account_name\":\""+rs.getString("account_name")+"\",";
