...
titleStr=" ผลสำเร็จศูนย์เทคโนโลยีโลหะและวัสดุแห่งชาติได้ 65.32%";
...
$dataJ2[0]["Field3"];
	...
	$($table).appendTo(e.detailCell);*/
						 ...
						 $("tr[data-uid]").css({"background-color":"#fefdc7"});
						$(".k-alt").css({"background-color":"#edf9a5"});
		...
		/*Remove  numberic  bottom tab*/
		/*Header Bgcolor*/
		$("th.k-header").css({"background-color":"#ffff00 "});
		$(".k-grid-header").css({"background-color":"#ffff00 "});
		/*Header Bgcolor*/
		/*Content Suffer Color Row*/
	//	$(".k-master-row").css({"background-color":"#fefdc7"});
		...
		/*Content Suffer Suffer Color Row*/
		/*Footer Bgcolor*/
		$(".k-pager-wrap").css({"background-color":"#ffff00"});
...
<div id="contentMain1">
	<div id="contentL">
	<img src="images/werasak.jpg">
	</div>
	<div id="contentR">
		<div id="contentDetail">
			ตัวชี้วัดผลสำเร็จศูนย์เทคโนโลยีโลหะและวัสดุแห่งชาติ <br>ประจำปีงบปรมาณ 2555
		</div>
	</div>
</div>
<br style="clear:both">
